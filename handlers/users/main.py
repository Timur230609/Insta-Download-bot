...
# async def download_tiktok_content(message: Message):
#     url = message.text.strip()
...
#             file.write(requests.get(video[0]).content)

#         await message.answer_video(
#             video=FSInputFile(file_name),
#             caption="📥 TikTok video yuklandi!",
...
#         await message.answer("⌛️ TikTok video yuklanmoqda...")
